-- Clean up all payments and fix the payment generation function properly
DELETE FROM payments;

-- Drop all dependent triggers first
DROP TRIGGER IF EXISTS generate_payments_on_contract_change ON contracts;
DROP TRIGGER IF EXISTS trg_generate_payment_schedule_after_ins_upd ON contracts;
